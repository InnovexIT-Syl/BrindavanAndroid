...
public class NoticeBoardActivity extends AppCompatActivity {
    ...
    Intent intentCommunicate, intentVehicle, intentFamily, intentResident, intentHome
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigate.navigateTo(this, noticeBtn, getIntent(), true);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            findViewById(R.id.noticeContainer).setBackgroundResource(R.drawable.shr_product_grid_background_shape);
        }
        else {
    ...
    private void setUpToolbar() {
        Toolbar toolbar = findViewById(R.id.notice_app_bar);
