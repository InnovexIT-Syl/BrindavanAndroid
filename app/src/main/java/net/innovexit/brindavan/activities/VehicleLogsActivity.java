...
public class VehicleLogsActivity extends AppCompatActivity {
    ...
    Intent intentNotice, intentCommunicate, intentFamily, intentResident, intentHome, intentDaily, intentGuestHelp, intentHire, intentService, intentSoS, intentUnannounced;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigate.navigateTo(this, vehicleBtn, getIntent(), true);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            findViewById(R.id.vehicleContainer).setBackgroundResource(R.drawable.shr_product_grid_background_shape);
        } else {
    ...
    private void setUpToolbar() {
        Toolbar toolbar = findViewById(R.id.vehicle_app_bar);
...
//                this.getResources().getDrawable(R.drawable.shr_close_menu))); // Menu close icon
    ...
    public void navigateTo(final Context context, final View view, final Intent intent, final boolean isSelf) {
