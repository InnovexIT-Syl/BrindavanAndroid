...
public class FamilyMembersActivity extends AppCompatActivity {
    ...
    Intent intentNotice, intentVehicle, intentCommunicate, intentResident, intentHome
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigate.navigateTo(this, familyBtn, getIntent(), true);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            findViewById(R.id.familyContainer).setBackgroundResource(R.drawable.shr_product_grid_background_shape);
        }
        else {
    ...
    private void setUpToolbar() {
        Toolbar toolbar = findViewById(R.id.family_app_bar);
