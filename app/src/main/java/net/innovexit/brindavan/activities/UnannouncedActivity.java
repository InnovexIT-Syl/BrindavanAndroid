...
public class UnannouncedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigate.navigateTo(this, unannouncedBtn, getIntent(), true);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            findViewById(R.id.unannouncedContainer).setBackgroundResource(R.drawable.shr_product_grid_background_shape);
        } else {
