...
public class SoSActivity extends AppCompatActivity {
    ...
    Intent intentNotice, intentVehicle, intentFamily, intentResident, intentHome
            , intentDaily, intentGuestHelp, intentHire, intentService, intentCommunicate, intentUnannounced;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigate.navigateTo(this, sosBtn, getIntent(), true);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            findViewById(R.id.sosContainer).setBackgroundResource(R.drawable.shr_product_grid_background_shape);
        }
        else {
    ...
    private void setUpToolbar() {
        Toolbar toolbar = findViewById(R.id.sos_app_bar);
